...
var proguctsAdd = document.querySelectorAll('.product__add');
var productsNode = document.querySelectorAll('.product');
var basketProductNode = document.querySelectorAll('.basket-popup__product');
var amoutProductsNode = document.querySelectorAll('.basket-popup__product-amout');
var count = 0;
...
addProducts(); // открытие и закрыьте корзины
