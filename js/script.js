...
var contentProducts = document.querySelectorAll('.products__content');
...
var basketProductsNode = document.querySelector('.basket-popup__products');
...
var basketPopupNode = document.querySelector('.basket-popup');
var basketNode = document.querySelector('.header__basket');
var basketBodyNode = document.querySelector('.basket-popup__body');
var closeBasketNode = document.querySelector('.basket-popup__close');
...
window.addEventListener('click', function (event) {
  ...
  if (event.target.dataset.action === 'plus' || event.target.dataset.action === 'minus') {
    var wrapperCounter = event.target.closest('.basket-popup__product-amout-w');
  ...
  if (event.target.dataset.action === 'minus') {
    if (parseInt(amout.innerText) > 1) amout.innerText = --amout.innerText;
  }
...
function calc() {
  var productItems = document.querySelectorAll('.basket-popup__product');
  var totalPrice = 0;
  var totalPriceEl = document.querySelector('.basket-popup__price');
  productItems.forEach(function (elem) {
    var amoutEl = elem.querySelector('[data-amout]');
    var priceEl = elem.querySelector('.basket-popup__product-price');
    var currentPrice = parseInt(amoutEl.innerHTML) * parseInt(priceEl.innerHTML);
...
var productsNode = document.querySelector('.basket-popup__products');

var productBasketStatus = function productBasketStatus() {
  var countProductsNode = document.querySelector('.header__basket-count');
  var countBasketProductsNode = document.querySelector('.basket-popup__amount-products');
...
var clearProductsBsket = function clearProductsBsket() {
  var clearProduct = document.querySelector('.basket-popup__clear-products');
  clearProduct.addEventListener('click', function () {
    var activeProduct = document.querySelectorAll('.basket-popup__product');
...
clearProductsBsket(); // открытие и закрытие фильтра

var filterNode = document.querySelector('.filter');
var filterPopupNode = document.querySelector('.filter-popup');
var opacityContent = document.querySelector('.popup-filter');
var filterPopupMenu = document.querySelector('.filter-popup__menu');
window.addEventListener('click', function (e) {
...
var filterItemLink = document.querySelectorAll('.filter-popup__nav-item-link');
var filterValue = document.querySelector('.filter__name');
...
var filterCategoryProducts = document.querySelector('.products__filters-checkbox');
var productsPopapCategory = document.querySelector('.filter-products-popup');
window.addEventListener('click', function (event) {
...
var burgerNode = document.querySelector('.burger');
var burgerMenuNode = document.querySelector('.burger-menu');
window.addEventListener('click', function (e) {
...
}); // изменение цвета при скроле для header
...
;// CONCATENATED MODULE: ./src/js/slick.min.js
